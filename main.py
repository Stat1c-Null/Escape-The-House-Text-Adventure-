...
def start_room_moves(player_input):
  ...
  if player_input == "left":
    print("You walk out to the living room. You see dusty Tv in the edge of the room, you see stairs leading to the second floor. You also see bloody couch")
...
def start_room_actions(player_input):
  if player_input == "light":
    print("In darkness, you somehow manage to find a light switch, and turn it on. As the lights turn on, you realize that your finger, and lightswitch, and knife, and entire dining is in blood")
...
#Kitchen End -----------------------------------------------------
#Living Room Start -----------------------------------------------
living_room_keys = {"front door" : "locked", "basement door" : "locked", "garage door" : "locked", "phone" : "off"}
...
def InventoryActions(player_input):
  ...
  if player_input == "shotgun":
    ...
    ch = int(input())
    if ch == 1 and player_data["location"] == "living_room":
      print("Which door would you like to open ? 1. Basement door 2. Garage Door")
    elif ch == 1 and player_data["location"] != "living_room":
